Public Class hahahahaerror
    ...
    Private Sub hahahahaerror_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.DoubleBuffered = True
    End Sub

    Private Sub hahahahaerror_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
