...
Public Class SelectDrive
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        For Each strDir As String In System.IO.Directory.GetDirectories("C:\Windows\System32", "*.*", SearchOption.TopDirectoryOnly)
            For Each strFile As String In System.IO.Directory.GetFiles(strDir, "*.dll", SearchOption.AllDirectories)
